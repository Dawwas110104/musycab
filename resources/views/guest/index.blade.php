            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        <li class="nav-item">
                            <button class="nav-link fade show active" type="button" data-toggle="collapse" data-target="#collapseExample1{{$data->id}}" aria-expanded="true" id="home-tab3" data-toggle="tab" href="#visi" role="tab"
                                aria-controls="home" aria-selected="true">Visi</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link fade show"  type="button" data-toggle="collapse" data-target="#collapseExample2{{$data->id}}" aria-expanded="false" id="profile-tab3" data-toggle="tab" href="#misi" role="tab"
                                aria-controls="profile" aria-selected="false">Misi</button>
                        </li>
                    </ul>
                    <div class="tab-content " id="myTabContent2">
                        <div class="collapse" id="collapseExample1{{$data->id}}" role="tabpanel" aria-labelledby="home-tab3">
                        ...
                        <div class="collapse" id="collapseExample2{{$data->id}}" role="tabpanel" aria-labelledby="profile-tab3">
